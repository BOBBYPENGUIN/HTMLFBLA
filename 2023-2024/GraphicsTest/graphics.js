var Graphics = function(xPos, yPos, scale, type){
    ...
    GRAYY = "rgb(100, 100, 100)"
    GRAY2 = "rgb(30, 30, 30)"
    LBLAC = "rgb(60,60,60)" 
    YELLO = "rgb(206,178,78)"
    BROW2 = "rgb(159,103,78)"
    BROW3 = "rgb(89,51,40)"
    GREE5 = "rgb(71,112,97)"
    LGRAY = "rgb(120,120,120)"
    REDD1 = "rgb(150,76,75)"   
    BROW4 = "rgb(123, 76, 58)"
    LBLUE = "rgb(143, 172, 173)"
}
Graphics.prototype.getColors = function(){
    if(this.type == 1){
        return this.drawWhiteSquare();
    } else if(this.type == 2){
        return this.getTopLeftMainHall();
    } else if(this.type == 3){
        return this.getBottomLeftMainHall();
    } else if(this.type == 4){
        return this.drawLegs();
    } else if(this.type == 5){
        return this.drawGrass();
    } else if(this.type == 6){
        return this.getTopRightMainHall();
    } else if(this.type == 7){
        return this.getBottomRightMainHall();
    }else if(this.type == 8){
...
Graphics.prototype.getTopLeftMainHall = function(){
    var colors = [
...
Graphics.prototype.getBottomLeftMainHall = function(){
    var colors = [
...
Graphics.prototype.getTopRightMainHall = function(){
    var colors = [
        [CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR],
        [CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR ,CLEAR],
...
Graphics.prototype.getBottomRightMainHall = function(){
    var colors = [
...
Graphics.prototype.drawUpperPlayerBodyFacingRight = function(){
    var colors = [
...
Graphics.prototype.drawLowerPlayerBodyFacingRight = function(){
    var colors = [
...
Graphics.prototype.drawUpperPlayerBodyFacingRightRF = function(){
    var colors = [
        [CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, BLACK, BLACK, BLACK, BLACK, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, CLEAR, BLACK, BLACK, DARKB, DARKB, DARKB, DARKB, BLACK, BLACK, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, BLACK, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, BLACK, CLEAR, CLEAR, CLEAR, CLEAR],
...
Graphics.prototype.drawLowerPlayerBodyFacingRightRF = function(){
    var colors = [
...
Graphics.prototype.drawUpperPlayerBodyFacingRightLF = function(){
    var colors = [
        [CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, BLACK, BLACK, BLACK, BLACK, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, CLEAR, BLACK, BLACK, DARKB, DARKB, DARKB, DARKB, BLACK, BLACK, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, BLACK, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, BLACK, CLEAR, CLEAR, CLEAR, CLEAR],
...
Graphics.prototype.drawLowerPlayerBodyFacingRightLF = function(){
    var colors = [
...
Graphics.prototype.drawLowerPlayerBody = function(){
    var colors = [
        ...
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, CLEAR, BLACK, BLACK, GRAYY, BLACK, CLEAR, CLEAR, BLACK, GRAYY, BLACK, BLACK, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, CLEAR, BLACK, BLACK, BLACK, BLACK, CLEAR, CLEAR, BLACK, BLACK, BLACK, BLACK, CLEAR, CLEAR, CLEAR],
    ]
    return colors;
}
Graphics.prototype.drawUpperPlayerBodyLF = function(){
    var colors = [
        [CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, BLACK, BLACK, BLACK, BLACK, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, BLACK, DARKB, DARKB, DARKB, DARKB, BLACK, BLACK, CLEAR, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, CLEAR, BLACK, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, BLACK, CLEAR, CLEAR, CLEAR],
...
Graphics.prototype.drawLowerPlayerBodyLF = function(){
    var colors = [
        ...
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAY2, GRAY2, GRAY2, CLEAR, BLACK, GRAYY, GRAY2, BLACK, CLEAR, CLEAR, CLEAR],
...
Graphics.prototype.drawUpperPlayerBodyRF = function(){
    var colors = [
        [CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, BLACK, BLACK, BLACK, BLACK, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, BLACK, DARKB, DARKB, DARKB, DARKB, BLACK, BLACK, CLEAR, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, CLEAR, BLACK, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, BLACK, CLEAR, CLEAR, CLEAR],
        [CLEAR, CLEAR, BLACK, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, DARKB, BLACK, CLEAR, CLEAR],
        [CLEAR, CLEAR, BLACK, DARKB, DARKB, DARKB, DARKB, SKINN, SKINN, SKINN, DARKB, DARKB, DARKB, BLACK, CLEAR, CLEAR],
        [CLEAR, CLEAR, BLACK, DARKB, DARKB, SKINN, SKINN, SKINN, SKINN, SKINN, SKINN, DARKB, DARKB, BLACK, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, BLACK, DARKB, BLACK, BLACK, BLACK, SKINN, SKINN, BLACK, BLACK, BLACK, DARKB, BLACK, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, BLACK, BLACK, WHIT1, BROW1, SKINN, SKINN, BROW1, WHIT1, BLACK, BLACK, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, BLACK, SKINN, WHITE, BROWN, SKINN, SKINN, BROWN, WHITE, SKINN, BLACK, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, SKINN, SKINN, SKINN, SKINN, SKINN, SKINN, BLACK, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, BLACK, SKINN, SKINN, SKINN, SKINN, BLACK, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, BLACK, CYANN, ROSEE, ROSEE, CYANN, BLACK, BLACK, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, BLACK, GRAYY, GRAYY, GRAYY, REDDD, REDDD, GRAYY, GRAYY, GRAYY, BLACK, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, BLACK, GRAYY, GRAYY, GRAYY, GRAYY, BLACK, BLACK, GRAYY, GRAYY, GRAYY, GRAYY, BLACK, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, BLACK, GRAYY, BLACK, GRAYY, GRAYY, REDDD, REDDD, GRAYY, GRAYY, BLACK, GRAYY, BLACK, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, BLACK, GRAYY, BLACK, GRAYY, GRAYY, REDDD, REDDD, GRAYY, GRAYY, BLACK, GRAYY, BLACK, CLEAR, CLEAR].reverse(),
    ]
    return colors;
}
Graphics.prototype.drawLowerPlayerBodyRF = function(){
    var colors = [
        [CLEAR, CLEAR, BLACK, GRAYY, GRAYY, BLACK, GRAYY, REDDD, REDDD, GRAYY, GRAYY, BLACK, GRAYY, BLACK, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, BLACK, BLACK, GRAYY, BLACK, GRAYY, REDDD, REDDD, GRAYY, GRAYY, BLACK, GRAYY, BLACK, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, BLACK, GRAYY, BLACK, GRAYY, GRAYY, GRAYY, GRAYY, GRAYY, BLACK, GRAYY, BLACK, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, SKINN, SKINN, SKINN, GRAYY, GRAYY, GRAYY, GRAYY, GRAYY, BLACK, SKINN, SKINN, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, SKINN, SKINN, SKINN, BLACK, BLACK, BLACK, BLACK, BLACK, BLACK, SKINN, SKINN, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAYY, GRAYY, GRAYY, GRAYY, GRAYY, GRAYY, BLACK, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAYY, GRAYY, GRAYY, GRAYY, GRAYY, GRAYY, BLACK, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAYY, BLACK, BLACK, BLACK, BLACK, GRAYY, BLACK, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAYY, GRAY2, GRAY2, CLEAR, BLACK, GRAYY, BLACK, CLEAR, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, BLACK, GRAY2, GRAY2, GRAY2, CLEAR, BLACK, GRAYY, GRAY2, BLACK, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, BLACK, BLACK, GRAY2, CLEAR, BLACK, GRAY2, GRAY2, BLACK, CLEAR, CLEAR, CLEAR].reverse(),
        [CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, CLEAR, BLACK, BLACK, BLACK, BLACK, CLEAR, CLEAR, CLEAR].reverse(),
    ]
    return colors;
}
