...
public class Assets extends JComponent{
    ...
    private Color[][] getLowerPlayerBodyFacingLeftLF(){
        Color[][] colors = {
            ...
            {CLEAR, CLEAR, BLACK, BLACK, GRAY2, GRAY2, BLACK, CLEAR, CLEAR, GRAY2, LBLAC, LBLAC, GRAY2, BLACK, CLEAR, CLEAR},
            {CLEAR, CLEAR, CLEAR, BLACK, BLACK, BLACK, CLEAR, CLEAR, CLEAR, BLACK, BLACK, BLACK, BLACK, CLEAR, CLEAR, CLEAR}
            };
        return colors;
    }
