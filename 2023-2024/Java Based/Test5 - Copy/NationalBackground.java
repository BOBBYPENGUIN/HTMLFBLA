...
public class NationalBackground extends JComponent{
    ...
    public void createBackground(){
        ...
        extras.add(new Assets(5*16*10, 5*16*10, 20, 30));
        extras.add(new Assets(6*16*10, 5*16*10, 20, 31));
        extras.add(new Assets(5*16*10, 6*16*10, 20, 32));
        extras.add(new Assets(6*16*10, 6*16*10, 20, 33));
