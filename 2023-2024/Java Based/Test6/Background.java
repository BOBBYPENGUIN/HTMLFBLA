...
public class Background extends JComponent{
    ...
    public void createBackground(){
        ...
        extras.add(new Assets(5*16*10, 5*16*10, 10, 26));
        extras.add(new Assets(6*16*10, 5*16*10, 10, 27));
        extras.add(new Assets(5*16*10, 6*16*10, 10, 28));
        extras.add(new Assets(6*16*10, 6*16*10, 10, 29));
